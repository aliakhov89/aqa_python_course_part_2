...
# Перший варіант з інпутом це шоб тут ранити
ans = 0
unique_objects = []
input_objects = input("Enter objects separated by spaces: ").split()
...
#Другий варіант - тут йде по objects - це для Степіка воно там йде по цьому списку(я поки вкурив чого воно не паше в них....)
ans = 0
unique_objects = []
